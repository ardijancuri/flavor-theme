...
<div x-data="{ open: false }">
    <h4
        class="text-sm font-semibold uppercase tracking-wider mb-4 cursor-pointer flex items-center justify-between lg:cursor-default"
        @click="open = !open"
    >
    ...
    <ul class="space-y-2 text-sm text-gray-400" :class="{ 'hidden': !open }" x-cloak x-show="open" x-transition class="lg:!block">
        <li>
